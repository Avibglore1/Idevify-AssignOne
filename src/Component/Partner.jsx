...
function Partner() {
  return (
    <>
     <div className='flex flex-col'>
      ...
      <div className='flex flex-col md:flex-row p-2 md:p-0'>
        <div className='flex flex-col items-center justify-center text-center w-full md:w-[50%]'>        
        ...
        <img src={meetingImgOne} alt="" className='w-full md:w-[50%]'/>
      </div>
      <div className='flex flex-col md:flex-row p-2 md:p-0'>
        <img src={meetingImgTwo} alt="" className='w-full md:w-[50%]'/>
        <div className='flex flex-col items-center justify-center text-center w-full md:w-[50%]'>
    ...
    <div className='mt-28'>
      ...
      <img src={Footer} className="h-100vh" alt="" />
    </div>
    </>
  )
}
